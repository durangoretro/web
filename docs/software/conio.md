...
|C|3|$03|`ETX`|**`TERM`**|&#9211; ball switch|BREAK|
|D|4|$04|`EOT`|**`ENDT`**|&#8690; arrow to SE corner||
...
|V|22|$16|`SYN`|**`PGDN`**|&#8609; double arrow down|page down (6)|
|W|23|$17|`ETB`|**`ATYX`**|&#9824; spade suit|set cursor position (5)|
|X|24|$18|`CAN`|**`BKTB`**|&#8676; left arrow with bar|backwards tabulation (6)|
|Y|25|$19|`EM`|**`PGUP`**|&#8607; double arrow up|page up (6)|
|Z|26|$1A|`SUB`|**`STOP`**|&#9940; no entry|send STOP signal (6)|
|-|27|$1B|`ESC`|**`ESC`**|&#11017; NW arrow/mouse cursor|escape|
|-|28|$1C|`FS`|**`PLOT`**|&#9698; wedge pointing SE||
|-|29|$1D|`GS`|**`DRAW`**|&#9699; wedge pointing SW||
|-|30|$1E|`RS`|**`INCG`**|&#9618; light pattern||
|-|31|$1F|`US`|**`TXTM`**|&#9619; mid pattern||
|-|127|$7F|`DEL`|**`DEL`**|&#8999;|delete (6)|
